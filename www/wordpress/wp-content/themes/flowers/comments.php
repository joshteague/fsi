...
<?php if ($comments) : ?>
	<h1 id="comments"><b>&nbsp;<?php comments_number('No comments', '1 comment', '% comments' );?></b></h1>
<div id="comments">
...
<b><?php comment_author_link()?></b> said&hellip;
			<?php comment_text() ?><h3><?php comment_date('F jS, Y') ?> <?php edit_comment_link('Edit','',''); ?></h3></li><br>
...
<h1 id="respond"><b>Post a comment</b></h1>
