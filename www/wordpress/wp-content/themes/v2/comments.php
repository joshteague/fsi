...
<div id="like-story"> 
        <iframe src="http://www.facebook.com/plugins/like.php?href=<?php the_permalink() ?>&amp;layout=standard&amp;show_faces=true&amp;width=450&amp;action=like&amp;font=arial&amp;colorscheme=light&amp;height=25" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:450px; height:25px;" allowTransparency="true"></iframe>          
        </div><br>
...
<div class="comments" id="comments">
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li class="<?php echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>">
			...
			<?php endif; ?>	
<b><?php comment_author_link()?></b> <span class="date"><?php comment_date('M d Y') ?> <?php edit_comment_link('Edit','',''); ?></span>
...
<h1 id="respond"><b><?php comment_form_title( 'Post a Comment', 'Post a Comment as %s' ); ?></b></h1>
